...
Write all `__*.md` workflow documents in system language unless the user asks otherwise. Keep them short, practical, and current. Do not add unstated requirements or expand scope without explicit user approval.
...
After user approval, work through `__TASK.md` from top to bottom.
